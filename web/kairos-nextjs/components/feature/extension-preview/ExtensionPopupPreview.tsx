...
/**
 * Preview en web del popup de la Chrome Extension.
 *
 * - `Card` envuelve el "popup" para tener borde + radius consistentes.
 * - `Progress` reemplaza la barra manual de meta diaria.
 * - Los CTAs internos son `Button` (icon + label) en lugar de `<button>` raw.
 */
    ...
    <main className="flex min-h-screen items-center justify-center bg-gradient-brand p-6">
      <div className="text-center">
        ...
        <Card
          shadow="lg"
          radius="lg"
          className="mx-auto overflow-hidden border border-border-subtle bg-bg-deep page-enter"
        ...
        >
          ...
          <section className="border-b border-border-subtle px-4 py-3">
            <div className="insight-border-left rounded-md bg-bg-elevated p-3 pl-4">
              ...
              <div className="mt-3 flex gap-2">
                <Button
                  startContent={<Pause size={12} strokeWidth={2.5} />}
                  radius="md"
                  size="sm"
                  fullWidth
                  className="bg-gradient-cta text-xs font-bold text-bg-deep shadow-glow-green data-[hover=true]:scale-[1.02]"
                >
                  Tomar pausa
                </Button>
                <Button
                  ...
                  size="sm"
                  fullWidth
                  className="border-border-active bg-bg-elevated text-xs font-medium text-text-secondary data-[hover=true]:text-text-primary"
                >
                  Seguir
                </Button>
              </div>
          ...
          <footer className="px-4 py-3">
            <Button
              ...
              className="border-border-subtle bg-bg-surface text-xs font-medium text-text-primary data-[hover=true]:border-border-active"
            >
              Abrir app completa
            </Button>
          </footer>
