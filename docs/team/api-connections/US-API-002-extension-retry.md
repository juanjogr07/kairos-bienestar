...
- [x] 401 no reintenta
- [x] Mergeado en `dev`
- [x] Build de extensión: `npm run build` sin errores — verificado en local
- [x] Endurecido: retries vía `chrome.alarms` (resistente a sleep del SW MV3)
- [x] Tests automatizados Jest (8 tests cubriendo el flujo de retry, 23 totales)
